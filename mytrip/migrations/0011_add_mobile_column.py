...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'mytrip_collect', (
            ('userid', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mytrip.User'], primary_key=True)),
            ('ctrip', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'mytrip', ['Collect'])


        # Changing field 'Trip_Location.photo'
        db.alter_column(u'mytrip_trip_location', 'photo', self.gf('django.db.models.fields.FilePathField')(path='/media', max_length=100, recursive=True))

    def backwards(self, orm):
        # Deleting model 'Collect'
        db.delete_table(u'mytrip_collect')


        # Changing field 'Trip_Location.photo'
        db.alter_column(u'mytrip_trip_location', 'photo', self.gf('django.db.models.fields.FilePathField')(path='/srv/www/pmem/media', max_length=100, recursive=True))
